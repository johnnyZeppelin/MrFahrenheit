...
if __name__=="__main__":
    ...
    for model_name in vlm_models:
        ...
        plot_metrics(per_category_metrics, overall_acc, overall_consistency, title=f"{model_name} - Per Category",
                     filename=model_fig_dir / "per_category.pdf")
        plot_metrics(per_trans_metrics, overall_acc, overall_consistency, title=f"{model_name} - Per Transformation",
                     filename=model_fig_dir / "per_transformation.pdf")

    # Multi-model comparison
    plot_multi_model(metrics_per_category_all_models, title="Multi-Model: Accuracy per Category",
                     filename=FIGURES_DIR / "multi_model_per_category.pdf")
    plot_multi_model(metrics_per_trans_all_models, title="Multi-Model: Accuracy per Transformation",
                     filename=FIGURES_DIR / "multi_model_per_transformation.pdf")
    ...
    print(f"[INFO] All plots saved under {FIGURES_DIR}")
